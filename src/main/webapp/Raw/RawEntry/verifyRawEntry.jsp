...
<fieldset>
    <h1>审核原料入库表</h1>
    <c:forEach items="${entrymap}" var="en" end="0">
    <p>
        <label>入库单号</label>
        <input class="sf" name="sf" type="text" value="${en.ENTRYNUM}" />
    ...
    <p>
        ...
        <select name="dropdown" class="dropdown">
            ...
            <option>${en.DELIVERYCOMPANYNAME}</option>
    ...
    <p>
        ...
        <select name="dropdown" class="dropdown">
            ...
            <option>${en.CLIENTNAME}</option>
        </select>
    </p>
    <p>
        <label>车牌号</label>
        <input class="sf" name="sf" type="text" value="${en.CLIENTNAME}" />
        <span class="field_desc">Field description</span>
    </p>
    <p>
        <label>烟叶年度</label>
    ...
    <p>
        <label>入库日期</label>
       <input type="date" value="${en.CLIENTNAME}">
    </p>
    <p>
        <label>审核日期:</label>
        <input type="date" value="${en.CLIENTNAME}">
    ...
    <p>
        <label>审核人</label>
        <input class="sf" name="formmaker" type="text" value="small input field" />
        <span class="field_desc">Field description</span></p>
